...
<body>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="index.html">Pasindo Pustaka<span>.</span></a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#services">Stok Produk</a></li>
  ...
  <main id="main">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>cari - cek detail buku - pesan sekarang.</p>
        </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h3>Pasindo Pustaka<span>.</span></h3>
            <p>
              Jalan Yos Sudarso <br>
              Karanglewas Lor, Purwokerto Barat 53136<br>
              Jawa Tengah <br><br>
